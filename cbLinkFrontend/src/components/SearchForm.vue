<template>
  <section
    class="sticky mx-auto max-w-4xl top-0 z-10 flex h-16 bg-white border-r-4 rounded-b-lg">
    <div class="flex flex-1 justify-between px-5 border-b border-gray-200">
      ...
      <div class="ml-4 flex items-center md:ml-6">
        <button
          type="button"
          class="rounded-full bg-white p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
